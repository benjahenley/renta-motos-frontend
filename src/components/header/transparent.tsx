...
export default function TransparentHeader() {
  ...
  return (
    <header
      ref={headerRef}
      className="transparent-header fixed left-0 top-0 z-[100] flex w-full items-center justify-between bg-white sm:bg-transparent  2xl:px-3 3xl:px-7 4xl:px-14 px-6"
    >

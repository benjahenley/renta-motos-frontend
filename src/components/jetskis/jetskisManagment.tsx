...
// const SimpleTable = ({ data, handleToggleMaintenance }: { data: Jetski[], handleToggleMaintenance: (id: string, currentStatus: boolean) => void }) => {
//   return (
...
//                   <Button onClick={() => handleToggleMaintenance(jetski.id, jetski.available)}>
...
//   const handleToggleMaintenance = (id: string, currentStatus: boolean) => {
